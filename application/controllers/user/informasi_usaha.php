		...
		<div id="map" style="margin-top:1em;margin-bottom:0.5em;width:500px; height:300px"></div></center>
			...
			<?php
				...
				{					
					...
					$query = mysql_query("SELECT nama_usaha,latitude,longitude FROM data_usaha WHERE nama_usaha LIKE '%$cari%'");
					...
					{ 
						...
						{
							$location[] = [$data['nama_usaha'], (float) $data['latitude'], (float) $data['longitude']];
						}
					?>
