...
if (isset($_POST['tambah']))
{
	...
	if($data_arr){
		...
		$sql = "INSERT INTO data_usaha VALUES(NULL,$username,$kecamatan,$kelurahan,NULL,NULL,'$n_usaha','$produk','$alamat',$latitude,$longitude, $omz,'$deskripsi')";
		echo $sql;
		die($sql);
		...
		if ($input)
		{
			...
			redirect("daftar_usaha_sukses.php");
		}
		else
		{
			echo 'Gagal menambahkan data! ';        //Pesan jika proses tambah gagal
			echo '<a href="pendaftaran_online.php">Kembali</a>';    //membuat Link untuk kembali ke halaman tambah
		}
	}
