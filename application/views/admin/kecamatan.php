...
<div class="row">
    <div class="col-lg-12 ">
        ...
        <div class="row">
            <div class="col-lg-6">
                <a href="<?php echo base_url('admin/kecamatan/addview'); ?>" class="btn btn-success"><i class="fa fa-plus"></i></a>
            ...
            <div class="col-lg-12">
                <div class="panel panel-default">
                    <div class="panel-heading">
                        <h3 class="panel-title"><i class="fa fa-tasks fa-fw"></i> Kecamatan</h3>
                    </div>
                            ...
                            <tbody>
                                ...
                                <?php foreach($datakecamatan as $row){?>
                                    <tr>
                                        ...
                                        <td class="text-center"><a href="<?php echo base_url('admin/kecamatan/editview/'.$row->id_kecamatan);?>" class="btn btn-warning"><i class="fa fa-pencil"></i></a>
                                            <a onclick="return confirm('Apakah anda yakin ingin menghapus data ini ?')" href="<?php echo base_url('admin/kecamatan/delete/'.$row->id_kecamatan); ?>" class="btn btn-danger"><i class="fa fa-trash"></i></a></td>
                                    </tr>
                                <?php $i++;?>
                                <?php }?>
                                <?php echo $linkpaging;?>
